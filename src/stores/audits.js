...
function mapFinding(f) {
  return {
    ...
    cobitRef:       Array.isArray(f.cobitRef) ? f.cobitRef[0] : (f.cobitRef || null),
    cosoRef:        Array.isArray(f.cosoRef)  ? f.cosoRef[0]  : (f.cosoRef  || null),
    rgsiRef:        Array.isArray(f.rgsiRef)  ? f.rgsiRef[0]  : (f.rgsiRef  || null),
    evidence:       f.evidence || [],
